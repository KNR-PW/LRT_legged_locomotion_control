...
ContactEstimator::ContactEstimator(const RobotModel& robot_model,
  ...
  : settings_(settings),
    contact_force_estimate_(robot_model.numContacts(), ocs2::vector3_t::Zero()),
    contact_force_estimate_prev_(robot_model.numContacts(), ocs2::vector3_t::Zero()),
    contact_surface_normal_(robot_model.numContacts(), ocs2::vector3_t::Zero()),
...
void ContactEstimator::update(const RobotModel& robot_model, 
  ...
  // Contact covariance
  for(int  i = 0;  i < num_contacts_; ++i) {
    const ocs2::scalar_t df = normal_contact_force_estimate_[i] - normal_contact_force_estimate_prev_[i];
...
const std::vector<ocs2::scalar_t>& ContactEstimator::getContactProbability() const {
  return contact_probability_;
}


const std::vector<ocs2::scalar_t>& ContactEstimator::getContactForceCovariance() const {
  return contact_force_covariance_;
}


// ocs2::scalar_t ContactEstimator::getContactForceCovariance() const {
...
//     }
//   }
//   ocs2::scalar_t contact_force_cov = 0;
//   for(int  i = 0;  i < num_contacts_; ++i) {
...
const std::vector<ocs2::vector3_t>& ContactEstimator::getContactForceEstimate() const {
  return contact_force_estimate_;
}


const std::vector<ocs2::scalar_t>& ContactEstimator::getNormalContactForceEstimate() const {
  return normal_contact_force_estimate_;
}


const std::vector<ocs2::vector3_t>& ContactEstimator::getContactSurfaceNormal() const {
